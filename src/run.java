...
class RaceFrame21 extends Frame implements ActionListener {
 ...
 public RaceFrame21(){
  ...
  img = Toolkit.getDefaultToolkit().getImage("turtle_image.png");
  img1 = Toolkit.getDefaultToolkit().getImage("turtle_image.png");
  img2 = Toolkit.getDefaultToolkit().getImage("turtle_image.png");
  img3 = Toolkit.getDefaultToolkit().getImage("turtle_image.png");
  img4 = Toolkit.getDefaultToolkit().getImage("turtle_image.png");
 }
